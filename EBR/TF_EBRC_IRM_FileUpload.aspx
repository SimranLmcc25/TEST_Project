<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_EBRC_IRM_FileUpload.aspx.cs" Inherits="EBR_TF_EBRC_IRM_FileUpload" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <asp:Label ID="pgLabel" runat="server" CssClass="pageLabel" Style="font-weight: bold">EBRC IRM File Upload</asp:Label>
                            </td>
