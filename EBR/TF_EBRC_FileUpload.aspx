<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_EBRC_FileUpload.aspx.cs"
    Inherits="EBR_TF_EBRC_FileUpload" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <asp:Label ID="pgLabel" runat="server" CssClass="pageLabel" Style="font-weight: bold">Transaction File Upload</asp:Label>
                            </td>
                                ...
                                <table cellspacing="0" cellpadding="0" border="0" width="100%" style="line-height: 150%">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:Button ID="btnupload" CssClass="buttonDefault" Text="Upload" runat="server"
                                                OnClick="btnupload_Click"/>  <%--OnClientClick="var b = confirmmessage(); if (b) ShowProgress(); return b"--%>
                                    ...
                                    <%-- <tr>
                                        <td colspan="4" align="left">
                                            <asp:Label ID="label1" runat="server" CssClass="pageLabel" BorderStyle="Inset" BorderWidth="3px"><br />&nbsp; Step 1: Select Excel File to be uploaded and click the upload button.In case there
             is any date format mismatch report will auto populate on the screen.&nbsp;&nbsp<br></br>&nbsp; Step 2: Click on validate to validate the data. If there are errors an error report will automatically open on the screen.<br></br>
            &nbsp; Step 3: In case of errors please correct the data in the excel file and continue from Step 1.<br></br>&nbsp; Step 4:Once all records are sucessfully validated click on &#39;Process&#39; button. <br></br>&nbsp;</asp:Label>
                                        </td>
                                    </tr>--%>
                                </table>
                                <br />
