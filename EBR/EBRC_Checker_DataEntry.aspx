<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EBRC_Checker_DataEntry.aspx.cs" Inherits="EBR_EBRC_Checker_DataEntry" %>
...
<head id="Head1" runat="server">
  ...
  <%--  <link type="text/css" href='<%=ResolveClientUrl("~/Style/style_new.css") %>' rel="stylesheet"
        media="screen" />
        <link type="text/css" href='<%=ResolveClientUrl("~/Style/Style.css") %>' rel="stylesheet"
        media="screen" />--%>
...
<%--    <link href="<%= ResolveUrl("~/Style/Style.css") %>" rel="stylesheet" type="text/css" />
    <link href="<%= ResolveUrl("~/Style/style_new.css") %>" rel="stylesheet" type="text/css" media="screen" />--%>
 ...
 <%-- <script language="javascript" type="text/javascript">
      ...
      function DialogAlert() {
        ...
        //  var Para1 = $("<p>", para).text("Do you want to approve transaction?");
          ...
          var message = _ddlApproveReject.val() == '2' ? "Do you want to Reject transaction?" : "Do you want to approve transaction?";
          var Para1 = $("<p>", para).text(message);
          $("body").append(div1);
          $("#divO").append(dialog);
          $("#dialog").append(Para1);
          $("#dialog").append(tablea);
 ...
 <%-- <script language="javascript" type="text/javascript">
      function DialogAlert() {
        ...
        },
        {
          ...
          } else if (_ddlApproveReject.val() == '2') {
              $("#dialog").append(tablea);
              $("#tblDialog").append(tr1);
                ...
                <table width="100%" cellpadding="1">
                    <tr>
                        <td colspan="4" align="left">
                            <span class="pageLabel"><strong>EBRC IRM Data Entry View- Checker </strong></span>
                        </td>
                 ...
                 <%--   <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtvalueDate" runat="server" Width="70px" CssClass="textBox" TabIndex="4"></asp:TextBox>
               ...
               <%--     <tr>
                        ...
                        <td align="left" colspan="3">
                            <asp:TextBox ID="txtCustAcNo" runat="server" CssClass="textBox" Style="width: 100px"
                                AutoPostBack="true" MaxLength="15" TabIndex="5"></asp:TextBox>
       ...
       <%--             <tr>
                        ...
                        <td colspan="3" align="left">
                            <asp:TextBox ID="txtRemitterAddress" CssClass="textBox" runat="server" MaxLength="100"
                                Width="500px" TabIndex="9"></asp:TextBox>
                        </td>
                    </tr>--%>
        <%--            <tr>
                        <td style="text-align: right">
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtRemitterBank" CssClass="textBox" runat="server" MaxLength="100"
                                Width="280px" TabIndex="10"></asp:TextBox>
                        </td>
                        <td style="text-align: right; white-space: nowrap;">
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtRemBankCountry" runat="server" CssClass="textBox" Style="width: 30px"
                                AutoPostBack="true" MaxLength="2" TabIndex="10"></asp:TextBox>
                            <asp:Button ID="Button5" runat="server" CssClass="btnHelp_enabled" TabIndex="-1" />
                            &nbsp;<asp:Label ID="lblRemBankCountryDesc" runat="server" CssClass="elementLabel"></asp:Label>
                        </td>
                    </tr>--%>
           <%--         <tr>
                ...
                <%--    <tr>
                   ...
                   <%-- <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="ddlCurrency" runat="server" CssClass="dropdownList" AutoPostBack="true"
                                TabIndex="13" Height="19px">
                            </asp:DropDownList>
                            &nbsp;
               ...
               <%--     <tr>
                ...
                <%--         <tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <ajaxToolkit:CalendarExtender ID="CalendarExtender3" runat="server" Format="dd/MM/yyyy"
                                TargetControlID="txtirmIssueDate" PopupButtonID="Button6" Enabled="True">
                            </ajaxToolkit:CalendarExtender>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                     ...
                     <%--   <td style="text-align: right">
                            <span class="elementLabel">ModeOfPayment : </span>
                        </td>
                        <td align="left">
                            <asp:TextBox ID="txtmodeOfPayment" runat="server" CssClass="textBox" Style="width: 70px"
                                TabIndex="17"></asp:TextBox>
                        </td>--%>
                    </tr>
                    <tr>
