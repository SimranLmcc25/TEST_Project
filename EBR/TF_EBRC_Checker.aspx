<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_EBRC_Checker.aspx.cs"
    Inherits="EBR_TF_EBRC_Checker" %>
...
<%# "<script src='" + ResolveClientUrl("~/Scripts/InitEndRequest.js") + "' type='text/javascript'></script>"%>
    ...
    function Confirm() {
        ...
        if (rowCount1 != 0) {
            if (rowCount1 == 1) {
                if (confirm("Do you want to approve IRM transaction?")) {
            ...
            if (rowCount1 != 1) {
                if (confirm("Do you want to approve bulk IRM transaction?")) {
                    confirm_value.value = "Yes";
                } else {
                    confirm_value.value = "No";
                }
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                ...
                                <span class="pageLabel" style="font-weight: bold">EBRC IRM Data Entry View-Checker</span>
                              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                             &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        ...
                        <tr>
                          ...
                          <tr align="right">
                            ...
                            <asp:RadioButton ID="rdb_Pending" runat="server" Text="Pending" AutoPostBack="true"
                                    GroupName="Status" Font-Bold="true" OnCheckedChanged="rdb_Pending_CheckedChanged"
                                    Checked="true" />
                                <asp:RadioButton ID="rdb_Approved" Text="Approved" AutoPostBack="true" GroupName="Status"
                                    runat="server" Font-Bold="true" OnCheckedChanged="rdb_Approved_CheckedChanged"
                                    ForeColor="GreenYellow" />
                                     <asp:RadioButton ID="rdb_Reject" runat="server" Text="Rejected" AutoPostBack="true" 
                                    GroupName="Status" ForeColor="Tomato"  Font-Bold="true" 
                                    oncheckedchanged="rdb_Reject_CheckedChanged"  />
                                    <span> (By DGFT) </span>
                                    </td>
                                      ...
                                      <asp:TemplateField HeaderText="Delete" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate>
                                                <asp:Button ID="btnDelete" runat="server" ToolTip="Delete Record" CommandName="RemoveRecord"
                                                    CommandArgument='<%#Eval("IRMNumber")%>' Text="Delete" />
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" Width="1%" />
                                            <ItemStyle HorizontalAlign="Center" Width="1%" />
                                        </asp:TemplateField>
