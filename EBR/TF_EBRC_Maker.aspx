<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_EBRC_Maker.aspx.cs" Inherits="EBR_TF_EBRC_Maker" %>
...
--%>
    ...
    <script type="text/javascript" src='<%=ResolveClientUrl("~/Scripts/jquerynew.min.js") %>'></script>
    <link href="../Scripts/JueryUI.css" rel="Stylesheet" type="text/css" media="screen" />
    <script type="text/javascript" src='<%=ResolveClientUrl("~/Scripts/jquery-ui.js") %>'></script> 
    <script type="text/javascript" src='<%=ResolveClientUrl("~/Scripts/MyJquery1.js") %>'></script> 
    <script type="text/javascript" src='<%=ResolveClientUrl("~/Scripts/Enable_Disable_Opener.js") %>'></script> --%>

    <%--<script type="text/javascript" src="" runat="server" ID="jsScript"></script>--%>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <asp:Label ID="pgLabel" runat="server" CssClass="pageLabel" Style="font-weight: bold">EBRC IRM Data Entry View-Maker</asp:Label>
                            </td>
                           <%-- <td align="right" style="width: 50%" valign="bottom">
                                <asp:Button ID="Button1" CssClass="buttonDefault" Text="Fetch Data" runat="server"
                      ...
                      <%--  <tr>
                          ...
                          <td align="left" style="width: 50%;" valign="top">
                                 ...
                                 <asp:Button ID="btncalendar_FromDate" runat="server" 
                                     ...
                                     <span class="elementLabel">IRM Status :</span>
                                      &nbsp;<asp:DropDownList ID="ddlIRMstatus" CssClass="dropdownList" AutoPostBack="true"
                                    runat="server" TabIndex="1" 
                                     onselectedindexchanged="ddlIRMstatus_SelectedIndexChanged">
                            ...
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewReturnData" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="UniqueTransactionId" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="lblBankUniqueTransactionId" runat="server" Text='<%#Eval("BankUniqueTransactionId")%>'
                                                    CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" Width="1%" />
                                            <ItemStyle HorizontalAlign="Center" Width="1%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="IRMNumber" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="lblIRMNumber" runat="server" Text='<%#Eval("IRMNumber")%>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" Width="1%" />
                                             <ItemStyle HorizontalAlign="Center" Width="1%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="IRMissueDate" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="lblIRMissueDate" runat="server" Text='<%#Eval("IRMissueDate")%>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" Width="1%" />
                                            <ItemStyle HorizontalAlign="Center" Width="1%" />
                                        </asp:TemplateField>
                                    <%--    <asp:TemplateField HeaderText="IFSCCode" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="RemittanceADCode" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="RemittanceDate" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRemittancedate" runat="server" Text='<%#Eval("Remittancedate")%>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" Width="1%" />
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="RemittanceCurrency" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRemittanceFCC" runat="server" Text='<%#Eval("RemittanceFCC")%>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" Width="1%" />
                                            <ItemStyle HorizontalAlign="Center" Width="1%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="RemittanceFCAmount" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRemittanceFCCAmount" runat="server" Text='<%#Eval("RemittanceFCCAmount")%>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" Width="1%" />
                                            <ItemStyle HorizontalAlign="Center" Width="1%" />
                                        </asp:TemplateField>
                                          ...
                                          --%>
                                           ...
                                           <asp:TemplateField HeaderText="Status" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" Visible="false">
                                            <ItemTemplate>
