...
public partial class CTR_STR_Transaction_View : System.Web.UI.Page
{
    ...
    protected void fillgrid()
    {
        ...
        string query = "STR_Get_CBATransactionFile";
    ...
    protected void LastTransID()
    {
        ...
        SqlParameter p2 = new SqlParameter("@BRANCHNAME", ddlbranch.Text.Trim());
        SqlParameter p3 = new SqlParameter("@Year", txtyear.Text);
        string query = "STR_Last_TransactionID";
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        if (ddlbranch.SelectedIndex.ToString() == "0")
        {
            ...
            Response.Redirect("STR_Transaction.aspx?mode=add&Branch=" + ddlbranch.SelectedValue.Trim() + "&TransID=" + TransID + "", true);
    }
    ...
    protected void GridViewTransactionFile_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            foreach (TableCell cell in e.Row.Cells)
            {
                ...
                string pageurl = "window.location='STR_Transaction.aspx?mode=edit&TransactionNo=" + lblTransID.Text.Trim() + "&TrnsactionDate=" + lblTransactionDate.Text.Trim() + "&Acno=" + lblAcNo.Text.Trim() + "&Branch=" + ddlbranch.SelectedValue.Trim() + "'";
    ...
    protected void GridViewTransactionFile_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        string query = "STR_Delete_CBATransactionFile";
        TF_DATA objData = new TF_DATA();
