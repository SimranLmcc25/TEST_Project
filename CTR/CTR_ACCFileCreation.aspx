<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CTR_ACCFileCreation.aspx.cs"
    Inherits="CTR_CTR_ACCFileCreation" %>
...
//            }
            ...
            if (txtBranchesSubmitted.value == '') {
                alert('Enter No of Branches Submitted CTR');
                    ...
                    <table width="100%" cellpadding="0" border="0">
                        <tr>
                            <td align="left" valign="bottom" colspan="4">
                                <span class="pageLabel" style="font-weight: bold">Generation of CTR File</span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td align="right" width="15%" nowrap>
                                <span class="elementLabel">No. of CTRs :</span>
                            </td>
                            <td align="left">
                        ...
                        <tr>
                            <td align="right">
                                <span class="elementLabel">No of Branches Submitted CTR : (Excluding NIL Report)</span>
                            </td>
                            <td align="left">
