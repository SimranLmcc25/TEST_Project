<%@ Page Language="C#" AutoEventWireup="true" CodeFile="STR_Transaction_View.aspx.cs" Inherits="CTR_STR_Transaction_View" %>
                    ...
                    <table width="100%" cellpadding="0" border="0">
                        <tr>
                            <td align="left" colspan="2" valign="bottom">
                                <span class="pageLabel" style="font-weight: bold">STR Transaction File Data Entry</span>
                            </td>
                            <td align="right">
                        ...
                        <asp:TextBox ID=txtCTR runat=server CssClass=textBox Text="STR" Enabled=false Width=40px></asp:TextBox>
