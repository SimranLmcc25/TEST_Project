...
public partial class CTR_CTR_ACCFileCreation : System.Web.UI.Page
{
    ...
    protected void fillReportSerialNo()
    {
        ...
        p1.Value = "";
        SqlParameter p2 = new SqlParameter("@TransType", "CTR");
    ...
    protected void InsertReportData()
    {
        ...
        SqlParameter p20 = new SqlParameter("@TransType", "CTR");
    ...
    protected string CBAACC()
    {
        ...
        TF_DATA objData = new TF_DATA();
        string query = "CTR_GenerationofAccountDataFile";
    ...
    protected string CBATRN()
    {
        ...
        string query = "CTR_GenerationofTansactionFile";
    ...
    protected string CBAINP()
    {
        ...
        string query = "CTR_GenerationofIndividualFile";
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            {
                linenumber = linenumber + 1;
                monthofreport = dt.Rows[i]["monthofreport"].ToString();
                yearofreport = dt.Rows[i]["yearofreport"].ToString();
    ...
    protected string CBALPE()
    {
        ...
        string query = "CTR_GenerationOfLegalPerson";
    ...
    protected string CBABRC()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            {
                linenumber = linenumber + 1;
                MonthofRepor = txtfromdate.Text.Substring(3, 2);
                YearofReport = txtfromdate.Text.Substring(6, 4);
    ...
    protected string CBACTL()
    {
        ...
        string query = "CTR_GenerationOfControlFile";
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                MonthOfReport = dt.Rows[i]["ReportMonth"].ToString();
                YearOfReport = dt.Rows[i]["YearofReport"].ToString();
                ...
                sw.WriteLine(linenumber.ToString("000000") + recordtype.PadRight(3,' ') + datastruc.PadRight(1,' ') + _ReportingEntityName.PadRight(80, ' ') + _ReportingEntityCategory.PadRight(5, ' ') + _RERegistrationNumber.PadRight(12, ' ') +
                       ...
                       _City.PadRight(50, ' ') +StateCode.PadRight(2,' ')+POfficerPinCode.PadRight(10, ' ')+CountryCode.PadRight(2,' ')+ POfficerTelephone.PadRight(30, ' ')+
                         ...
                         Date.PadRight(10, ' ') + MonthOfReport + YearOfReport + _OperationalMode.PadRight(1, ' ') + _BatchType.PadRight(1, ' ')
    ...
    {
        _directoryPath = Server.MapPath("~/CTR_GeneratedFiles/" + txtfromdate.Text.Substring(6, 4) + txtfromdate.Text.Substring(3, 2));
      ...
      //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Generation of Branch File ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        if (count > 0)
        {
            ...
            string path = "file://" + servername + "/CTR_GeneratedFiles";
            string link = "/CTR_GeneratedFiles";

            LabelMessage.Text = "CTR File Created Successfully on " + servername + " in " + "<a href=" + path + "> " + link + " </a>";
        }
        else
    ...
    {
        string query = "CTR_LastReport_SerialNo";
    ...
    //protected void txtTotalBranches_TextChanged(object sender, EventArgs e)
    //{
    //    //branchcount();
    ...
    //    if (dt.Rows.Count > 0)
    //    {
    //        txtTotalBranches.Text = dt.Rows[0]["TotalBranch"].ToString();
    //    }
    //}
}